  ...
  return (
    <section className="py-20 px-6 md:px-16 bg-gray-50">
      ...
      <div className="text-center max-w-3xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-extrabold text-[#2C3E50] animate-fadeInUp">
          Explore the Hidden Gems of Sikkim
        </h2>
        <p className="text-gray-600 mt-4 text-lg md:text-xl animate-fadeInUp delay-200">
      ...
      {/* Mobile Gallery */}
      <div className="flex md:hidden gap-4 h-[400px] overflow-x-auto snap-x snap-mandatory mt-12 px-2 scrollbar-hide">
        {galleryImages.map((img, i) => (
          <div
            key={i}
            className="relative flex-shrink-0 w-64 h-[400px] rounded-xl snap-start cursor-pointer shadow-lg"
          >
            <img
